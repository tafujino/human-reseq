...
outputs:
  - id: chrY_interval_list
    type: File
    outputBinding:
      glob: $(inputs.reference.basename).chrY.interval_list

arguments:
  - position: 1
    valueFrom: "{if ($1 == \"chrY\") print $1\"\t1\t\"$2\"\t+\t\"$1}"
  - position: 3
    valueFrom: "|"
  - position: 4
    valueFrom: "cat"
  ...
  - position: 7
    valueFrom: ">"
  - position: 8
    valueFrom: $(inputs.reference.basename).chrY.interval_list
